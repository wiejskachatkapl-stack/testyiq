...
## v1091
Moduł Zapałki został przebudowany z pytań wielokrotnego wyboru na interaktywną planszę. Użytkownik wybiera aktywną zapałkę, następnie wolne miejsce, może cofnąć ruch, zresetować układ, skorzystać z podpowiedzi i sprawdzić wynik.


## v1091
Naprawiono sprawdzanie interaktywnych zadań Zapałki. Program nie porównuje już ruchu wyłącznie z jednym zapisanym rozwiązaniem. Odczytuje cyfry i znaki z aktualnego układu zapałek, oblicza równanie i akceptuje każde prawidłowe rozwiązanie wykonane jednym ruchem.


## v1091
Rozbudowano interaktywny moduł Zapałki do 24 zweryfikowanych zagadek. Pierwsze poziomy wymagają przesunięcia jednej zapałki, a trudniejsze dokładnie dwóch. Program pokazuje liczbę wykonanych i pozostałych ruchów oraz nadal akceptuje każde matematycznie poprawne rozwiązanie.


## v1091
Przebudowano bank zagadek Zapałki. Każda zagadka jest automatycznie sprawdzana wobec wszystkich prawidłowych równań o tej samej liczbie zapałek. Zadania dwuruchowe są odrzucane, jeżeli istnieje jakiekolwiek rozwiązanie jednym ruchem. Pozostawiono wyłącznie zagadki z jednym, jednoznacznym rozwiązaniem o dokładnie wymaganej liczbie ruchów.


## v1091 — Co nie pasuje? w wersji obrazkowej
- przebudowano moduł z tekstowych przykładów na klikalną planszę 6 obrazków,
- przygotowano 144 lokalnych grafik SVG w 18 kategoriach,
- generator losuje pięć obrazków jednej kategorii i jeden element niepasujący,
- pozycja wyjątku jest losowana,
- po poprawnej odpowiedzi wyświetlane jest objaśnienie ukrytej reguły,
- punktacja nie została przebudowana — zgodnie z ustaleniem najpierw dopracowujemy zagadki.


## v1091 — korekta widoku „Co nie pasuje?” na komputerze
Zmniejszono wyłącznie kafelki obrazkowe modułu „Co nie pasuje?” w widoku komputerowym. Plansza mieści się teraz w przeznaczonej przestrzeni i nie nachodzi na sekcję podpowiedzi ani rozwiązania. Widoku telefonu i mechaniki zadań nie zmieniano.


## v1091 — trudniejsze zagadki „Co nie pasuje?”
- usunięto automatyczne zestawy oparte na kilku prawie identycznych grafikach,
- każdy obiekt ma teraz jedną, unikalną ilustrację,
- dodano 36 ręcznie zaprojektowanych i sprawdzonych reguł,
- poziom łatwy opiera się na kategoriach,
- poziom średni wykorzystuje środowisko, funkcję, napęd, odżywianie i budowę,
- poziom trudny wykorzystuje m.in. kręgowce, stałocieplność, botaniczne owoce i budowę ciała,
- grafiki nie zawierają podpisów zdradzających odpowiedź,
- poziom trudności dobierany jest przez istniejący mechanizm adaptacyjny,
- punktacji nie zmieniano.


## v1091 — próbny naturalny styl
Bazą ponownie jest v1088. Odrzuconych ilustracji z v1089 nie użyto. Podmieniono osiem obiektów na prawdziwe, naturalne fotografie: lew, tygrys, wilk, lis, niedźwiedź, orzeł, sowa i papuga. Pierwsza zagadka modułu „Co nie pasuje?” zawsze pokazuje fotograficzny zestaw pięciu ssaków oraz orła, aby styl można było ocenić natychmiast. Pozostałe grafiki i mechanika pozostają z v1088.


## v1091 — pełna przebudowa „Co nie pasuje?”
- wymieniono cały katalog `assets/odd` na spójny zestaw 100 nowych grafik PNG w stylu zaakceptowanego clipartu,
- utworzono 25 kategorii użytkownika, po 4 grafiki w każdej,
- tryb podstawowy i średni używa 4 obrazków w układzie 2×2,
- tryb zaawansowany używa 9 obrazków w układzie 3×3,
